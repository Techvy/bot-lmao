...
class tictactoe(commands.Cog):
    ...
    async def tictactoe(self, interaction: discord.Interaction, enemy: discord.Member):
        ...
        player2_name = enemy.display_name
        player1_mention = interaction.user.mention
        player2_mention = enemy.mention
        await interaction.response.send_message(f'`Tic Tac Toe game has started!`\n{player1_mention} -> X\n{player2_mention} -> O.\n**__{player1_name}__** goes first\n', view=TicTacToe())
